...
async def play(client: Client, message_: Message):
    ...
    res = await message_.reply_text("✯Imteyaz✯=🔄 Processing... Song")
    ...
    if message_.chat.id in tgcalls.pytgcalls.active_calls:
        ...
        await res.edit_text(f"✯Imteyaz✯=#️⃣ Queued at position {position}.")
    else:
        await res.edit_text("✯Imteyaz✯=▶️ Playing... Song")
        res.delete
